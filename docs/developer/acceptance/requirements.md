...
| RQ-28 | Motion and fitting errors stay distinct | P13, P15 | P13: visible scope selector separates reusable template motion, shared Appearance and binding-local transforms, reports the number of bindings affected by shared changes, and links motion errors directly back to the dummy editor |
...
| RQ-30 | Name and label an outfitted NPC | P13, P15 | P13: modal collects validated portable name, optional description and project labels before stable Character/Appearance/Binding creation; existing NPC edits use revision+SHA baselines and change-scope-only transaction writes |
...
| RQ-36 | Project/area/NPC/animation filesystem hierarchy | P03, P15–P16 | P13: unnamed drafts live under `.area/drafts`; first save journals four ordered replacements for the character, `appearances/default.json`, action binding and assigned draft in the normal project/area tree without copying the released motion; export trees follow P16 |
...
| RQ-40 | Complete plan and executable phase prompts | P00–P22 | P00–P13 implemented in order and gated; P14 is next |
